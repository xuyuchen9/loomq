...
import com.loomq.wal.IntentBinaryCodec;
import com.loomq.wal.SimpleWalWriter;
 ...
 * @since v0.6.1
 */
public class IntentWalV2 implements AutoCloseable {

    private static final Logger logger = LoggerFactory.getLogger(IntentWalV2.class);
    ...
    public IntentWalV2(WalConfig config, String shardId) throws IOException {
        this(config, shardId, "node-1");
    }

    public IntentWalV2(WalConfig config, String shardId, String nodeId) throws IOException {
        this.shardId = shardId;
        this.nodeId = nodeId;
        this.walWriter = new SimpleWalWriter(config, shardId);
        logger.info("IntentWalV2 created for shard: {}", shardId);
    }
    ...
    public void setReplicationManager(ReplicationManager replicationManager) {
        ...
        logger.info("IntentWalV2: ReplicationManager set for shard: {}", shardId);
    }
    ...
    public void start() {
        walWriter.start();
        logger.info("IntentWalV2 started for shard: {}", shardId);
    }
    ...
    public void close() {
        walWriter.close();
        logger.info("IntentWalV2 closed for shard: {}", shardId);
    }
